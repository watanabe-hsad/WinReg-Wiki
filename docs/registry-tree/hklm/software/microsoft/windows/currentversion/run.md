...
<div><span class="ww-card-kicker">Registry Fact Card</span><strong>HKLM\SOFTWARE\Microsoft\Windows\CurrentVersion\Run</strong></div>
...
<div class="ww-fact-wide"><span>Native path</span><div class="ww-path-stack"><span class="ww-path-pill">HKLM\SOFTWARE\Microsoft\Windows\CurrentVersion\Run</span><span class="ww-path-pill">HKLM\SOFTWARE\Microsoft\Windows\CurrentVersion\RunOnce</span><span class="ww-path-pill">HKLM\SOFTWARE\WOW6432Node\Microsoft\Windows\CurrentVersion\Run</span></div></div>
</div>
...
<div><span>Related data</span><span class="ww-chip ww-chip--data">data/registry: hklm-software-run</span><span class="ww-chip ww-chip--data">artifact: run-keys</span></div>
</div>
</div>
