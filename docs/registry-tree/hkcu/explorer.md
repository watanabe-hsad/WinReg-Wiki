...
| 名称 | 类型 | 含义 |
|---|---|---|
| `UserAssist\{GUID}\Count` | Key | Explorer 相关程序交互记录。 |
| [`RunMRU`](software/runmru.md) | Key | Win+R Run dialog 输入历史。 |
| [`RecentDocs`](software/recentdocs.md) | Key | 最近文档名称和扩展名分组。 |
| [`ComDlg32`](software/comdlg32.md) | Key | 打开 / 保存对话框 MRU。 |
| `MountPoints2` | Key | 用户见过的卷、盘符和网络共享。 |
